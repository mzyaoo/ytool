...
@Service
public class MySQLTableDataStrategy implements DbTableDataStrategy {
    ...
    public List<TableInfo> listTables(Connection connection, String schema) {
        ...
        try {
            ...
            ResultSet rs = metaData.getTables(connection.getCatalog(), connection.getSchema(), "%", new String[]{"TABLE"});
            while (rs.next()) {
